[![Run App Michael Timm](https://github.com/mtimm11/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/mtimm11/GithubActions/actions/workflows/run-app.yaml)
